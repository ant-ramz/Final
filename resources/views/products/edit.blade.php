        ...
        <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input name="name" type="text" required value="{{ old('name', $product->name) }}" class="w-full border rounded px-3 py-2" placeholder="e.g., Chocolate Bar">
                </div>
                <div>
                    <label class="block text-sm font-medium mb-1">Description</label>
                    <input name="description" type="text" value="{{ old('description', $product->description) }}" class="w-full border rounded px-3 py-2" placeholder="Optional description">
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div id="components-container" class="space-y-4">
                    @php
                        if (old('components')) {
                            ...
                            $existing = $product->components->map(function($c){
                                return [
                ...
                <div>
                    <button type="button" id="add-component" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 text-sm">
                        + Add Component
                    </button>
                </div>
            </div>
